...
class Banking:
    ...
    def login(self):
        ...
        if self.banking == "boa":
            self.userquerry = "SELECT * FROM boa WHERE Fname = %s and Password = %s"
            print("Processing...")
            time.sleep(1)
            self.confirm()
        elif self.banking == "kuda":
            self.userquerry = "SELECT * FROM kuda WHERE Fname = %s and Password = %s"
            print("Processing...")
            time.sleep(1)
            self.confirm()
        elif self.banking == "opay":
            self.userquerry = "SELECT * FROM opay WHERE Fname = %s and Password = %s"
            print("Processing...")
            time.sleep(1)
            self.confirm()
        else:
    ...
    def buy_airtime(self):
        ...
        while len(phone) != 11:
            print("phone must be 11 didgits")
            phone = input("ENTER YOUR PHONE NUMBER:>>> ")
        else:
